...
/* after each write check to see if stream returns false,
 if so wait for the next drain before trying to write agian.
*/
const stream = require('stream');

const writable = new stream.Writable({ highWaterMark: 10 });
